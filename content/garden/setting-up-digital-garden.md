...
---
> [!note] Disclaimer
This is not another setup guide. These are my experiences and customizations that someone might find useful.
...
I didn't want the old history of Quartz to bulk up my git repo. So I removed the .git folder, and reinitialized the git and added remote for my own GitHub repo.
